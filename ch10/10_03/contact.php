...
if (isset($_POST['send'])) {
    ...
    $authorized = null;
    // This is necessary because the script in process_mail.php assumes that the post array will contain all elements listed in the expected array. Setting the value to an empty string will add terms to the missing array if it's a required field.
